...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
   switch(GPIO_Pin)
   {
   case PHOTO0_Pin:								// ?��무것?�� ?�� ?��?�� ?�� 1�??

      ext_int_no = GPIO_Pin;
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_0);   // LED1  // 2�?? // flag2 == 1?���?? 2�?? ~ flag2 == 0?���?? 1�??
      //lcd?�� �?? 출력 2�??

      break;
   case PHOTO1_Pin:
      ext_int_no = GPIO_Pin;
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_7);   // LED2  // 3�?? // flag3 == 1?���?? 3�?? ~ flag3 == 0?���?? 2�??
      break;
   case PHOTO2_Pin:
      ext_int_no = GPIO_Pin;
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_14);   // LED3 // 4�?? // flag4 == 1?���?? 4�?? ~ flag4 == 0?���?? 3�??
      break;
   case PHOTO3_Pin:
      ext_int_no = GPIO_Pin;
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_0);   // LED1 // 5�?? // flag5 == 1?���?? 5�?? ~ flag5 == 0?���?? 4�??
      break;
   case PHOTO4_Pin:
      ext_int_no = GPIO_Pin;
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_0);   // LED1 // 6�?? // flag6 == 1?���?? 6�?? ~ flag6 == 0?���?? 5�??
      break;
   }
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|FND6_Pin|FND4_Pin|FND7_Pin
                          |LD3_Pin|FND5_Pin|FND2_Pin|FND1_Pin
  ...
  /*Configure GPIO pins : PHOTO3_Pin PHOTO4_Pin */
  GPIO_InitStruct.Pin = PHOTO3_Pin|PHOTO4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : LD1_Pin FND6_Pin FND4_Pin FND7_Pin
                           LD3_Pin FND5_Pin FND2_Pin FND1_Pin
                           FND9_Pin FND10_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|FND6_Pin|FND4_Pin|FND7_Pin
                          |LD3_Pin|FND5_Pin|FND2_Pin|FND1_Pin
                          |FND9_Pin|FND10_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
